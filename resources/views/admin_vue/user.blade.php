                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Table Utilisateur</h4>
                        </div>
                            ...
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td>{{$Users->id}}</td>
                                        <td>{{$Users->name}}</td>
                                        <td>{{$Users->nom_eleve}}</td>
                                        <td>{{$Users->prenom_eleve}}</td>
                                        <td>{{$Users->contact_eleve}}</td>
                                        <td>{{$Users->ville_residence_eleve}}</td>
                                        <td>{{$Users->email}}</td>
                                        <td>{{$Users->experience_professionnel_eleve}}</td>
