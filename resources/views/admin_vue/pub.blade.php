                ...
                <ul class="nav">
                    ...
                    <li class="has-sub">
                        ...
                        <ul class="sub-menu">
                            ...
                            <li><a href="">Tout Les Utilisateurs</a></li>
                        </ul>
                    </li>
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr class="odd gradeX">
                                        <td>{{$Event->id}}</td>
                                        <td>{{$Event->description_publication}}</td>
                                        <td>{{$Event->category->titre_category}}</td>
                                        <td>{{$Event->created_at}}</td>
                                        <!-- <td>{{($Event->admins_id_pub) == 1 ? 'Super Codeur':'Other Admin'}}</td> -->
                                        <td> <a href="{{ route('events.show', ['event'=>$Event->id] ) }},{{$Event->id}}/edit">   
                                            <button class="btn btn-warning"><span class="glyphicon glyphicon-pencil"></span></button></a></td>
                                        <td><form action="{{ route('events.destroy',$Event) }}" method="POST"
