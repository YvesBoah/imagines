                ...
                <div class="col-md-10">
                    ...
                    <div class="panel panel-inverse">
                        <div class="panel-heading">
                            ...
                            <h4 class="panel-title">Table Offre D'Emplois</h4>
                        </div>
                        ...
                        <div class="panel-body">
                            <table id="data-table" class="table table-striped table-bordered">
                                ...
                                <tbody>
                                     @if(count($Offres_Emplois)>0)
                                     @foreach($Offres_Emplois as $emplois) 
                                    <tr class="odd gradeX">
                                        <td>{{$emplois->id}}</td>
                                        <td>{{$emplois->titre_emplois}}</td>
                                        <td>{{$emplois->description_emplois}}</td>
                                        <td>{{$emplois->created_at}}</td>
                                        <td>{{$emplois->updated_at}}</td>
                                    </tr>
                                    @endforeach
                                    @else
                                     <tr class="odd gradeX">
